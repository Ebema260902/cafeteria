        ...
        <div className="max-w-screen-2xl mx-auto w-full px-10 lg:px-16 flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-5 flex-shrink-0">
            <a
              ...
              className={`hidden sm:inline-flex items-center gap-2 px-6 py-2.5 rounded-full font-inter text-[12px] font-medium tracking-wide uppercase transition-all duration-300 ${
                scrolled
                  ? "bg-mauve text-white hover:bg-berry"
                  : "bg-white/12 border border-white/30 text-white hover:bg-white/20 backdrop-blur-sm"
              }`}
            >
